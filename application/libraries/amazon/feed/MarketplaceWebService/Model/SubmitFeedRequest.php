...
include_once (APPPATH.'libraries/amazon/feed/Model.php');
include_once (APPPATH.'libraries/amazon/feed/MarketplaceWebService/Model/ContentType.php');
/*include_once (APPPATH.'libraries/amazon/feed/MarketplaceWebService/Model/IdList.php');*/
