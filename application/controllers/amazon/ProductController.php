...
class ProductController extends CI_Controller {
	...
	public function index() {
		...
		$getAllProductData = $this->getAllProductData($config,$service);
		...
		if($getAllProductData['status'] == 1 ) { // data found so no need to call another api
			...
			$requestReportArr = $this->invokeRequestReport($service, $request); // if condition here
	...
	function getAllProductData($config,$service) {
		...
		$getReportListId = $this->invokeGetReportList($service, $request);
