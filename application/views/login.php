...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('assests/app-assets/vendors/css/forms/icheck/icheck.css'); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('assests/app-assets/vendors/css/forms/icheck/custom.css'); ?>">
    <!-- END: Vendor CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('assests/app-assets/css/pages/login-register.css'); ?>">
    <!-- END: Page CSS-->
...
<body class="vertical-layout vertical-menu 1-column bg-full-screen-image blank-page" data-open="click" data-menu="vertical-menu" data-col="1-column">
                    ...
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="col-lg-4 col-md-8 col-10 box-shadow-2 p-0">
                            <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                                ...
                                <h6 class="card-subtitle line-on-side text-muted text-center font-small-3 pt-2"><span><b>Login</b></span></h6>
                                    ...
                                    <div class="card-body">
                                        <form method="post" class="form-horizontal" action="<?php echo base_url('LoginController/login'); ?>">
                                            ...
                                            <!-- <div class="form-group row">
                                                <div class="col-md-12">
                                                    <a href="#" class="card-link" style="float: right;">Forgot Password?</a>
                                                </div>
                                            </div> -->
    ...
    <script src="<?php echo base_url('assests/app-assets/vendors/js/forms/validation/jqBootstrapValidation.js'); ?>"></script>
    <script src="<?php echo base_url('assests/app-assets/vendors/js/forms/icheck/icheck.min.js'); ?>"></script>
    <!-- END: Page Vendor JS-->
    ...
    <!-- BEGIN: Page JS-->
    <script src="<?php echo base_url('assests/app-assets/js/scripts/forms/form-login-register.js'); ?>"></script>
    <!-- END: Page JS-->
