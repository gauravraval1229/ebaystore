                        ...
                        <div class="card">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-10">
                              ...
                              <form method="POST" action="<?php echo base_url('ebay/LocationController/addNewLocation'); ?>">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-9">
                                    <button type="submit" name="btnAddNewLocationSubmit" class="btn btn-info" style="margin-bottom: 12px;">Submit</button>
                                  </div>
                                </div>
                              </form>
